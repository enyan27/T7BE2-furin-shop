...
<body>
          ...
          <div class="language-currency d-none d-lg-block">
            <div class="d-flex">
              ...
              <a href="/my-account/profile" class="language-currency-list text-white d-flex">
                <img style="border-radius: 50%; height: 25px; width: 25px;" class="language-currency-list-icon" src="/{{Auth::user()->avatar ?? 'storage/uploads/user/no_avatar.png'}}" alt="{{Auth::user()->fullname}}" />{{Auth::user()->fullname}}
              </a>
            ...
            <div class="header-search d-flex">
              <div class="header-select-categories">
                <select name="cate_search" class="header-select-inner">
                  ...
                  <option {{request('cate_search') == $child->slug ? 'selected' : '' }} value="{{$child->slug}}">{{$child->categoryname}}</option>
                  @endforeach
                  @endif
                  @endforeach
                </select>
              ...
              <li class="header-account-item">
                ...
                <a class="header-account-btn" href="/wishlist">
                  ...
                  <a class="header-account-btn" href="/login">
                    ...
                    @if(Auth::check())
                    <?php
                    $wishList = count(Auth::user()->wishListItems) ?>
  ...
  <script src="/customer/assets/js/comment.js"></script>
